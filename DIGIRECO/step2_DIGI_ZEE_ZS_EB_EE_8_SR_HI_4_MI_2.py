...
process.GlobalTag.toGet = cms.VPSet(
  cms.PSet(record = cms.string("EcalSRSettingsRcd"),
    ...
    connect = cms.string("sqlite_file:EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_8_SR_HI_4_MI_2.db")
    )
  )
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_DIGI_ZEE_ZS_EB_EE_8_SR_HI_4_MI_2_HS.root'),
