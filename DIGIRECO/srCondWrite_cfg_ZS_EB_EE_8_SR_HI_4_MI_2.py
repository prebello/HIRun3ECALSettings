...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_8_SR_HI_4_MI_2.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_8_SR_HI_4_MI_2')
    ))
)
...
# ZS energy threshold in GeV to apply to low interest channels of barrel
process.writeInDB.ebDccAdcToGeV = cms.double(0.035)
process.writeInDB.srpBarrelLowInterestChannelZS = cms.double(8.0*0.035) #value changed here Pat

#added Pat
process.writeInDB.srpBarrelHighInterestChannelZS = cms.double(8.0*0.035)

# ZS energy threshold in GeV to apply to low interest channels of endcap
process.writeInDB.eeDccAdcToGeV = cms.double(0.06)
process.writeInDB.srpEndcapLowInterestChannelZS = cms.double(8.0*0.06)  #value changed here Pat

#added Pat
process.writeInDB.srpEndcapHighInterestChannelZS = cms.double(8.0*0.035)
