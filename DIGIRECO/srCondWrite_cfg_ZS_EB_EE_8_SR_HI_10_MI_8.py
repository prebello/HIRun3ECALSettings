...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_8_SR_HI_10_MI_8.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_8_SR_HI_10_MI_8')
    ))
)
...
#    mode = cms.string("online_config"), #import online SRP config from onlineSrpConfigFile file and bxGlobalOffset,
    ...
    #for debug mode only:
    trigPrimBypassLTH = cms.double(8.0),  #value changed Pat
