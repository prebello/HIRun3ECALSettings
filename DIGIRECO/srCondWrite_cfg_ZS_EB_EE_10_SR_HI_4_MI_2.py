...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_10_SR_HI_4_MI_2.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalSRSettings_beam2018_option1_v00_mc_ZS_EB_EE_10_SR_HI_4_MI_2')
    ))
)
