...
# with command line options: Configuration/GenProduction/python/HIN-HINPbPbAutumn18GS-00033-fragment.py --python_filename HIN-HINPbPbAutumn18GS-00033_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIN-HINPbPbAutumn18GS-00033.root --conditions 103X_upgrade2018_realistic_HI_v11 --beamspot RealisticPbPbCollision2018 --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --scenario HeavyIons --geometry DB:Extended --era Run2_2018_pp_on_AA --no_exec --no_exec --mc -n 22
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIN-HINPbPbAutumn18GS-00033-fragment.py nevts:22'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIN-HINPbPbAutumn18GS-00033.root'),
