...
# with command line options: Configuration/GenProduction/python/HIN-HINPbPbAutumn18GSHIMix-00183-fragment.py --python_filename HIN-HINPbPbAutumn18GSHIMix-00183_1_cfg.py --eventcontent RAWSIM --pileup HiMixGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIN-HINPbPbAutumn18GSHIMix-00183.root --pileup_input dbs:/MinBias_Hydjet_Drum5F_2018_5p02TeV/HINPbPbAutumn18GS-103X_upgrade2018_realistic_HI_v11-v1/GEN-SIM --conditions 103X_upgrade2018_realistic_HI_v11 --beamspot MatchHI --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(270270) --step GEN,SIM --scenario HeavyIons --geometry DB:Extended --era Run2_2018_pp_on_AA --no_exec --mc -n 174475
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIN-HINPbPbAutumn18GSHIMix-00183.root'),
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(270270)
